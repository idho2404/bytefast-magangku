  ...
  <div class="p-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-center mb-4 space-y-4 sm:space-y-0">
      <div class="flex flex-wrap justify-center sm:justify-start space-x-2">
        ...
        <button
          class="bg-green-500 text-white px-4 py-2 rounded hover:bg-blue-600 hover:border-none flex items-center justify-center mb-2 sm:mb-0 w-full sm:w-auto"
        >
      ...
      <div class="flex space-x-2">
        <input type="month" v-model="selectedMonth" class="border border-gray-300 bg-indigo-500 rounded px-2 py-1" />
      </div>
    </div>
    ...
    <div class="bg-white dark:bg-black dark:text-white py-6 rounded-lg overflow-x-auto">
      <table class="w-full text-left table-auto border ">
        ...
        <tbody class="text-gray-700 text-sm font-light">
          <tr class="border-b border-gray-200 hover:bg-purple-100 dark:hover:bg-indigo-500" v-for="(entry, index) in logbookEntries" :key="index">
    ...
    <div v-if="showModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
      <div class="bg-gradient-to-r from-purple-800 to-indigo-800 p-6 rounded-lg shadow-lg w-full max-w-md">
