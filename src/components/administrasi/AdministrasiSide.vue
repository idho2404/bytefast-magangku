      ...
      >
        <div class="p-4">
          <div class="border-b-2 mb-10">
            <h1 class="text-2xl text-center font-bold mb-2 text-white">LINK</h1>
          </div>
          <nav>
            <ul>
              <!-- Presensi -->
              <li class="mb-8">
                <a
                  ...
                  :class="['flex items-center', currentView === 'Presensi' ? 'text-white' : 'hover:text-white']"
                >
                  <svg class="w-5 h-5 mr-4 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
              ...
              <li class="mb-8">
                <a
                  ...
                  :class="['flex items-center', currentView === 'LogbookHarian' ? 'text-white' : 'hover:text-white']"
                >
                  <svg class="w-5 h-5 mr-4 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
              ...
              <li class="mb-8">
                <a
                  ...
                  :class="['flex items-center', currentView === 'LaporanMagang' ? 'text-white' : 'hover:text-white']"
                >
                  <svg class="w-5 h-5 mr-4 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li class="mb-8">
                <a
                  ...
                  :class="['flex items-center', currentView === 'BimbinganMagang' ? 'text-white' : 'hover:text-white']"
                >
                  <svg class="w-5 h-5 mr-4 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li class="mb-8">
                <a
                  ...
                  :class="['flex items-center', currentView === 'PerizinanKampus' ? 'text-white' : 'hover:text-white']"
                >
                  <svg class="w-5 h-5 mr-4 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li class="mb-8">
                <a
                  ...
                  :class="['flex items-center', currentView === 'Template' ? 'text-white' : 'hover:text-white']"
                >
                  <svg class="w-5 h-5 mr-4 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
