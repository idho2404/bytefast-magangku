<template>
  <div class="flex flex-col min-h-screen p-5 border-r-2 dark:bg-black dark:text-white">
    ...
    <div class="flex flex-col md:flex-row">
      <!-- Sidebar -->
      <aside
        class="w-full md:w-64 bg-gradient-to-r from-purple-700 to-indigo-600 text-white p-6 rounded-lg md:fixed md:top-16 md:left-5 md:ml-5 md:mt-5 md:mb-5 shadow-lg flex flex-col justify-between "
      >
        <div class="p-4">
